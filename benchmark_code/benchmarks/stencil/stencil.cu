...
#ifdef SIZE0
  parameters->inpFiles[0] = "~/software/parboil-2.5/datasets/stencil/small/input/128x128x32.bin";
  nx = 128;
  ny = 128;
  nz = 32;
  iteration = ITERS;
#endif
#ifdef SIZE1
  parameters->inpFiles[0] = "~/software/parboil-2.5/datasets/stencil/default/input/512x512x64x100.bin";
  nx = 512;
  ny = 512;
  nz = 64;
  iteration = ITERS;
