...
#ifdef SIZE0
  params->inpFiles[0] = "~/software/parboil-2.5/datasets/bfs/NY/input/graph_input.dat";
#endif
#ifdef SIZE1
  params->inpFiles[0] = "~/software/parboil-2.5/datasets/bfs/1M/input/graph_input.dat";
#endif
